                    ...
                    <form id="formCamiseta">
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="cor" name="cor" placeholder="Ex: Azul, Amarelo, Verde" required> 
                            </div>
                            <div class="form-group mb-3">
                                <label for="tamanho">Tamanho:</label>
                                <input type="text" class="form-control" id="tamanho" name="tamanho" placeholder="Ex: G, M, P" required> 
                            </div>
                        </div>
